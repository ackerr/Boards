# Generated by Django 2.0.3 on 2018-03-08 13:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('topics', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='topics', to='Board.Board')),
            ],
        ),
        migrations.AddField(
            model_name='post',
            name='topic',
            field=models.ManyToManyField(related_name='posts', to='Board.Topic'),
        ),
        migrations.AddField(
            model_name='post',
            name='updated_by',
